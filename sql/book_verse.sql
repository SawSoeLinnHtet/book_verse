...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2659562357ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=book_verse&table=books">`book_verse`.`books`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=book_verse&table=admins">`book_verse`.`admins`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="64392829557648742c4e35583f796d4d">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="book_verse" targettable="admins">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admins`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="book_verse" targettable="books">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
